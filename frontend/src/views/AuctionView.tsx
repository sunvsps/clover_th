...
/** The auction page: round picker and the selected round (live claim, ranked queue, or results). The queues have their own page. */
export default function AuctionView({ visible, isThai, isAdmin, memberId, members, notify }: Props) {
  ...
  const { round, refresh, apply, error } = useRound(roundId, visible);
