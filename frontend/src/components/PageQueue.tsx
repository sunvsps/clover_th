...
import { itemLabel, queueCategories, type BoardMember as GuildMember, type CategoryClaims, type QueueCategory, type QueueLogEntry, type Queues } from "../lib/pageAuction";
...
export default function PageQueue({ isThai, isAuthenticated, isAdmin, userName, jobs, members, queues, claims, pages, roundOpen, log, onJoin, onLeave, onGoToAuction }: Props) {
