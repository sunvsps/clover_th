...
const messages: Record<string, Text> = {
  ...
  LEFTOVER_LIVE_CLAIM_ONLY: { en: "Only a closed live-claim round can make a leftover draft.", th: "สร้างรอบไอเท็มที่เหลือได้เฉพาะรอบจองสดที่ปิดแล้ว" },
  LEFTOVER_NOT_REPEATABLE: { en: "This round is already a leftover round; it can't be repeated again.", th: "รอบนี้เป็นรอบไอเท็มที่เหลืออยู่แล้ว ทำซ้ำอีกไม่ได้" },
  NO_LEFTOVER_ITEMS: { en: "Every item of this round was claimed or disabled, so nothing is left over.", th: "ไอเท็มในรอบนี้ถูกจองหรือปิดใช้งานหมดแล้ว ไม่มีของเหลือ" },
